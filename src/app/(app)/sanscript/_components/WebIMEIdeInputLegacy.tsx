...
export interface WebIMEIdeLegacyProps extends React.ComponentProps<"input"> {
 ...
 */
const WebIMEIdeInputLegacy = React.forwardRef<
  HTMLInputElement,
  WebIMEIdeLegacyProps
>(
  (
    {
      className,
...
WebIMEIdeInputLegacy.displayName = "WebIMEIdeInputLegacy";

export default WebIMEIdeInputLegacy;
